<div class="content-inner container-fluid pb-0" id="page_layout">
                    ...
                    <div class=" iq-product-weather d-flex gap-2">
                        <div class=" d-flex flex-column align-items-center">
                            <svg class="text-primary icon-35" xmlns="http://www.w3.org/2000/svg" width="35" viewBox="0 0 44 44" fill="none">
                                ...
                                <path d="M25.6663 32.5926V36.6667M18.333 18.3334V22.4074V18.3334ZM18.333 28.5186V32.5926V28.5186ZM25.6663 22.4074V26.4815V22.4074Z" stroke="#EBEEFD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card" style="background: rgb(226 244 249); box-shadow: 0 1px 8px rgb(0 0 0 / 20%), 0 3px 4px rgb(0 0 0 / 14%), 0 3px 3px -2px rgb(0 0 0 / 12%);">
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-md-5">
                            <img src="<?= base_url('assets/dashboard.png') ?>" width="100%" alt="">
                        </div>
                        <div class="col-md-6">
                            <h4 class="text-bold text-weight-bolder mt-2" style="color: rgb(96, 191, 220); text-shadow: rgb(0, 74, 206) 1px 2px 2px;">Sistem Informasi Akademik <br>Universitas Bahaudin Mudhary Madura</h3>
            ...
            <div class="card">
                <div class="card-body">
                    <h5><svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
