<li class="nav-item">
    <a class="nav-link collapsed" data-bs-toggle="collapse" href="#keuangan-master" role="button" aria-expanded="false" aria-controls="keuangan-master">
    ...
    <ul class="sub-nav collapse" id="keuangan-master" data-bs-parent="#sidebar-menu">
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link " href="#/dosen">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Pembayaran" data-bs-placement="right"> PY </i>
