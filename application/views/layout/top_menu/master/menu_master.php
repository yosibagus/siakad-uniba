<li class="nav-item">
    ...
    <ul class="iq-header-sub-menu list-unstyled collapse" id="allPagesData">
        <li class="nav-item">
            <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#keuangan" role="button" aria-expanded="false" aria-controls="keuangan">
                Keuangan
                <i class="right-icon">
            ...
            <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="keuangan">
                <li class="nav-item"><a class="nav-link " href="#/">Tagihan</a></li>
                <li class="nav-item"><a class="nav-link " href="#/">Pembayaran</a></li>
            </ul>
        </li>
        <li class="nav-item">
            <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#referensi" role="button" aria-expanded="false" aria-controls="referensi">
                Referensi
                <i class="right-icon">
                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
            ...
            <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="referensi">
                <li class="nav-item"><a class="nav-link " href="#/prodi">Data Program Studi</a></li>
                <li class="nav-item"><a class="nav-link " href="#/matakuliah">Data Matakuliah</a></li>
                <li class="nav-item"><a class="nav-link " href="#/gedung">Data Gedung</a></li>
            </ul>
        </li>
    </ul>
</li>