<li class="nav-item">
    ...
    <ul class="iq-header-sub-menu list-unstyled collapse" id="allPagesData">
        <li class="nav-item">
            <a class="nav-link menu-arrow " data-bs-toggle="collapse" href="#globalsetting" role="button" aria-expanded="false" aria-controls="globalsetting">
                Setting Global
                <i class="right-icon">
            ...
            <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="globalsetting">
                <li class="nav-item"><a class="nav-link " href="#/global_setting">Setting Main</a></li>
                <li class="nav-item"><a class="nav-link " href="#/">Konfigurasi WS</a></li>
                <li class="nav-item"><a class="nav-link " href="#/">Ubah Logo</a></li>
                <li class="nav-item"><a class="nav-link " href="#/">Identitas PT</a></li>
        ...
        <li class="nav-item">
            ...
            <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="authSkins">
                <li class="nav-item"><a class="nav-link " href="#/daftar_user">Daftar User</a></li>
                <li class="nav-item"><a class="nav-link " href="#/">Pimpinan & Operator</a></li>
                <li class="nav-item"><a class="nav-link " href="#/generate_mahasiswa">Generate User Mahasiswa</a></li>
                <li class="nav-item"><a class="nav-link " href="#/generate_dosen">Generate User Dosen</a></li>
                <li class="nav-item"><a class="nav-link " href="#/">Generate User Alumni</a></li>
            </ul>
        </li>
    </ul>
</li>