<li class="nav-item">
    <a class="nav-link collapsed" data-bs-toggle="collapse" href="#referensi-menu" role="button" aria-expanded="false" aria-controls="referensi-menu">
    ...
    <ul class="sub-nav collapse" id="referensi-menu" data-bs-parent="#sidebar-menu">
        <li class="nav-item">
