    ...
    <ul class="sub-nav collapse" id="sidebar-maps" data-bs-parent="#sidebar-menu">
        <li class="nav-item">
            <a class="nav-link " href="#/global_setting">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Main Setting" data-bs-placement="right">
                    SM </i>
                <span class="item-name">Setting Main</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Konfigurasi WS" data-bs-placement="right">
                    WS </i>
                <span class="item-name">Konfigurasi WS</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Ubah Logo" data-bs-placement="right">
                    ULG </i>
                <span class="item-name">Ubah Logo</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Identitas PT" data-bs-placement="right">
                    IPT </i>
                <span class="item-name">Identitas PT</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="">
                ...
                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Backup & Restore Database" data-bs-placement="right">
                    DB </i>
                <span class="item-name">Backup & Restore</span>
            </a>
        </li>
    </ul>
</li>