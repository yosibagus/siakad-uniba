<?php if ($this->session->userdata('tipe') == "DOSEN") : ?>
    <li class="nav-item">
        <a class="nav-link " href="#/kelas_perkuliahan_order">
...
<?php elseif ($this->session->userdata('tipe') == "KADEP") : ?>
    <li class="nav-item">
        <a class="nav-link " href="#/kelas_perkuliahan_order">
            <i class="icon" data-bs-toggle="tooltip" title="Kelas Perkuliahan" data-bs-placement="right">
                <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 20 20" fill="none">
    ...
    <li class="nav-item">
        <a class="nav-link" href="#/dosen_wali" id="dosen_wali">
            <i class="icon" data-bs-toggle="tooltip" title="Dosen Wali" data-bs-placement="right">
